...
<style>
    ...
    select.form-control,
    .form-control:not(#amount):not([name="amount"]) {
        border: none;
...
<div class="flex items-center justify-end text-sm text-gray-500 px-2 pt-2 md:hidden">
    ...
    <div class="card rounded-lg p-10 max-w-3xl mx-auto" style="background-image: url(assets/images/hero/hero-image-1.svg);">
        <p class="mb-6 text-lg font-semibold text-neutral-900 dark:text-white">Choose An Investment Plan to Deposit</p>
...
<div>
    ...
    <span class="text-red-600 text-sm mt-1 block">@error('plan_id'){{ $message }}@enderror</span>
                ...
                <div>
                    <label for="wallet_id" class="block mb-2 font-semibold text-neutral-900 dark:text-white">
                ...
                <div class="md:col-span-2">
                    <label for="amount" class="block mb-2 font-semibold text-neutral-900 dark:text-white">
