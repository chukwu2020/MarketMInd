   ...
   >
    ...
    <div class="container mx-auto"  style="background-image: url(assets/images/hero/hero-image-1.svg);   
        ...
        <div class="space-y-6">
            ...
            <div class="border border-gray-200 rounded-2xl shadow p-6" style="border-top: 4px solid #9EDD05;">
                    ...
                    <table class="w-full text-sm text-left border border-gray-200">
                        <tbody>
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="px-4 py-2 font-medium" style="color: #0C3A30;">
                            ...
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="px-4 py-2 font-semibold" style="color: #0C3A30;">
                                    ${{ number_format($investment->amount_invested + $investment->total_profit, 2) }}
                                </td>
                            </tr>
                            <tr>
